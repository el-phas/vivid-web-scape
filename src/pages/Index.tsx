...
const Index = () => {
  ...
  const displayFilteredProfessionals = filterContentByMode(professionals, searchRadius);
  const displayFilteredBusinesses = filterContentByMode(businesses, searchRadius);
  ...
  const displayedProfessionals = displayFilteredProfessionals.length > 0 ? displayFilteredProfessionals : filterContentByMode(fallbackProfessionals, searchRadius);
  const displayedBusinesses = displayFilteredBusinesses.length > 0 ? displayFilteredBusinesses : filterContentByMode(fallbackBusinesses, searchRadius);
