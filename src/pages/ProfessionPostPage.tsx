        ...
        <div className="bg-white rounded-md overflow-hidden shadow-sm mb-4">
          <div className="p-3 border-b">
            <div className="flex items-center">
              ...
              />
              <div>
                <p className="font-medium text-sm">John Doe <span className="text-gray-500 font-normal">· Software Engineer</span></p>
                <div className="flex items-center mt-0.5">
                  <span className="text-xs text-blue-500">DevTask</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            <img 
              src="public/lovable-uploads/cc3a59a4-79a7-4b48-9384-7143e2f35b67.png" 
...
export default ProfessionPostPage;
